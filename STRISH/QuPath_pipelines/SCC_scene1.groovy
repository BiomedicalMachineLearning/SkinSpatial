...
cy7_params.put("minArea", new Float(0.3))
cy7_params.put("maxArea", new Float(20.0))
cy7_params.put("intensityThreshold", new Float(17.0))
...
cy5_params.put("minArea", new Float(0.3))
cy5_params.put("maxArea", new Float(20.0))
cy5_params.put("intensityThreshold", new Float(17.0))
...
cy3_params.put("minArea", new Float(0.3))
cy3_params.put("maxArea", new Float(30.0))
cy3_params.put("intensityThreshold", new Float(18.0))
...
dapi_params.put("intensityThreshold", new Float(30.0))
...
current_scene_number = 'SCC_Scene_1.2'
