...
cy7_params.put("minDisplay", new Float(150.0))
cy7_params.put("maxDisplay", new Float(245.0))
...
cy7_params.put("minArea", new Float(0.05))
cy7_params.put("maxArea", new Float(15.0))
cy7_params.put("intensityThreshold", new Float(10.0))
...
cy5_params.put("minDisplay", new Float(190.0))
cy5_params.put("maxDisplay", new Float(300.0))
...
cy5_params.put("minArea", new Float(0.05))
cy5_params.put("maxArea", new Float(15.0))
cy5_params.put("intensityThreshold", new Float(15))
...
cy3_params.put("minDisplay", new Float(180.0))
cy3_params.put("maxDisplay", new Float(500.0))
...
cy3_params.put("sigmaMicrons", new Float(0.75))
cy3_params.put("minArea", new Float(0.1))
cy3_params.put("maxArea", new Float(15.0))
cy3_params.put("intensityThreshold", new Float(17.5))
cy3_params.put("watershedPostProcess", new Boolean(false))
// set it low because it's RNA not cell, just make use of detection function
cy3_params.put('cellExpansionMicrons', new Float(0.5))

def fitc_params = new HashMap()
fitc_params.put("minDisplay", new Float(850.0))
fitc_params.put("maxDisplay", new Float(2500.0))
fitc_params.put("requestedPixel", new Float(0.075))
fitc_params.put("bgradius", new Float(1.0))
// control threshold for the detected object shape
fitc_params.put("medianRadiusMicrons", new Float(0.0001))
fitc_params.put("sigmaMicrons", new Float(0.5))
fitc_params.put("minArea", new Float(0.1))
fitc_params.put("maxArea", new Float(15.0))
fitc_params.put("intensityThreshold", new Float(40.0))
fitc_params.put("watershedPostProcess", new Boolean(false))
// set it low because it's RNA not cell, just make use of detection function
fitc_params.put('cellExpansionMicrons', new Float(0.5))

def dapi_params = new HashMap()
dapi_params.put("minDisplay", new Float(50.0))
dapi_params.put("maxDisplay", new Float(7500.0))
dapi_params.put("requestedPixel", new Float(0.25))
dapi_params.put("bgradius", new Float(1.09))
// control threshold for the detected object shape
...
dapi_params.put("maxArea", new Float(30.0))
dapi_params.put("intensityThreshold", new Float(70.0))
